...
import { formatReadCount, getPostReads, onReadMetricsChange, recordPostRead } from "./read-metrics.js";
...
function renderModal() {
  ...
  postModalTag.textContent = tag;
  postModalDate.textContent = formatDate(post.date, locale);
  postModalReading.textContent = reading;
  postModalReads.textContent = readText(getPostReads(post.id), locale);

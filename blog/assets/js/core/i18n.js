...
const translations = {
  zh: {
    ...
    "weather.locationFallback": "定位不可用（已使用备用坐标）",
    "weather.locationDenied": "定位权限被拒绝，请在浏览器中开启位置权限",

    "stats.timeTitle": "时间分配",
    "stats.timeDesc": "最近 90 天我的精力分配如下，主要时间依旧投入在技术与内容。",
    "stats.spaceTitle": "足迹",
    "stats.spaceDesc": "自动记录你访问过的城市，跨城时会显示连接路径。",
    "stats.locationPending": "等待定位...",
    "stats.footprintEmpty": "还没有足迹记录，允许定位后会自动开始。",
    "stats.footprintCount": "已记录 {count} 个城市节点",
    "stats.bar.dev": "开发",
  ...
  en: {
    ...
    "weather.locationFallback": "Location unavailable (using fallback coordinates)",
    "weather.locationDenied": "Location permission denied. Enable location in browser settings.",
    ...
    "stats.spaceDesc": "Cities are recorded automatically, and cross-city moves are linked as a path.",
    "stats.locationPending": "Waiting for location...",
    "stats.footprintEmpty": "No footprint yet. Allow location and it will start recording.",
    "stats.footprintCount": "{count} city nodes recorded",
    "stats.bar.dev": "Build",

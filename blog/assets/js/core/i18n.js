...
const translations = {
  zh: {
    ...
    "landing.subtitle": "参考 zzzzshawn.cloud 的首屏结构，在顶部融合个人简介、工具栈与当前状态。",
  ...
  en: {
    ...
    "landing.subtitle": "Inspired by zzzzshawn.cloud, this top area merges profile, stack, and current focus.",
    "landing.quote": "Build things people want, then keep refining with focus.",
    ...
    "landing.scrollHint": "Scroll down for the full site ↓",
    "landing.techTitle": "Tech Stack",
    "landing.dailyTitle": "Daily Stack",
    "landing.linksTitle": "Links",

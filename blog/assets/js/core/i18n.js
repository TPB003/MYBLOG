...
const translations = {
  zh: {
    ...
    "landing.kicker": "INSPIRED ENTRY",
    "landing.title": "我在构建更安静、更耐用的个人数字系统。",
    "landing.subtitle": "参考 zzzzshawn.cloud 的卡片布局，首屏直接展示身份、技术栈与当前状态。",
    "landing.quote": "Build things people want, then keep refining with focus.",
    "landing.statusA": "可协作状态",
    "landing.statusB": "基于中国 / Global Remote",
    "landing.statusC": "周更新节奏",
    "landing.enter": "进入主页",
    "landing.knowledge": "打开知识库",
    "landing.scrollHint": "向下滑动查看完整内容 ↓",
    "landing.techTitle": "Tech Stack",
    "landing.dailyTitle": "Daily Stack",
    "landing.linksTitle": "Links",
    "landing.dailyA": "长文写作 + 知识卡沉淀",
    "landing.dailyB": "代码交付与视觉细节打磨",
    "landing.dailyC": "阅读与每周复盘",
    "landing.linkBooks": "阅读清单",
    "landing.linkKnowledge": "知识库",
    "landing.frontend": "Frontend:",
    "landing.backend": "Backend:",
    "landing.services": "Db & Services:",
    "landing.buildPrefix": "I build ",
    "landing.intro": "Hello, I'm TP. I design focused products and long-term knowledge systems.",
    "landing.miniQuote": "\"How do I keep shipping every week?\"",
    "landing.available": "可工作状态",
    "landing.toolWord": "工具",
    "landing.skyCaption": "from NASA · 1999-09-28",
    "landing.albumTitle": "Fox on the Run",
    "landing.narutoQuote": "“我要成为火影。”",
    "landing.projectMeta": "工程中",
  ...
  en: {
    ...
    "landing.kicker": "INSPIRED ENTRY",
    "landing.title": "I build calm digital systems.",
    "landing.subtitle": "Inspired by zzzzshawn.cloud card rhythm, this top section shows identity, stack, and current status first.",
    "landing.quote": "Build things people want, then keep refining with focus.",
    "landing.statusA": "Available for collaboration",
    "landing.statusB": "Based in China / Global Remote",
    "landing.statusC": "Shipping weekly",
    "landing.enter": "Enter Dashboard",
    "landing.knowledge": "Open Knowledge Base",
    "landing.scrollHint": "Scroll down for full content ↓",
    "landing.techTitle": "Tech Stack",
    "landing.dailyTitle": "Daily Stack",
    "landing.linksTitle": "Links",
    "landing.dailyA": "Long-form writing + knowledge cards",
    "landing.dailyB": "Code shipping and visual polish",
    "landing.dailyC": "Reading and weekly review",
    "landing.linkBooks": "Reading List",
    "landing.linkKnowledge": "Knowledge",
    "landing.frontend": "Frontend:",
    "landing.backend": "Backend:",
    "landing.services": "Db & Services:",
    "landing.buildPrefix": "I build ",
    "landing.intro": "Hello, I'm TP. I design focused products and long-term knowledge systems.",
    "landing.miniQuote": "\"How do I keep shipping every week?\"",
    "landing.available": "Available for work",
    "landing.toolWord": "Tool",
    "landing.skyCaption": "from NASA · 1999-09-28",
    "landing.albumTitle": "Fox on the Run",
    "landing.narutoQuote": "“I'm gonna be Hokage one day.”",
    "landing.projectMeta": "In Build",

...
const translations = {
  zh: {
    ...
    "meta.description": "TPBLOG 的个人博客与知识库，记录技术、创作、生活与足迹。",
    ...
    "stats.spaceTitle": "足迹",
    "stats.spaceDesc": "默认路线是连云港到上海，你可以持续追加新城市并自动连线。",
    "stats.routeEmpty": "暂无路线",
    "stats.routeInputLabel": "新增城市",
    "stats.routePlaceholder": "输入城市名，如：杭州",
    "stats.routeAdd": "添加",
    "stats.routeReset": "重置路线",
    "stats.routeAddShort": "请输入至少 2 个字符的城市名。",
    "stats.routeAddNotFound": "没有找到这个城市，请尝试更完整的名称。",
    "stats.routeAddDuplicate": "这个地点已经在路线中，未重复添加。",
    "stats.routeAddFailed": "添加失败，请检查网络后重试。",
    "stats.routeClearConfirm": "确认重置路线为默认的“连云港 -> 上海”吗？",
    "stats.footprintEmpty": "还没有足迹节点，先添加一个城市吧。",
    "stats.routeCount": "共 {count} 站",
    "stats.bar.dev": "开发",
  ...
  en: {
    ...
    "meta.description": "TPBLOG personal hub for engineering, writing, life notes, and footprint routes.",
    ...
    "stats.spaceDesc": "The default route starts with Lianyungang -> Shanghai, and you can keep appending cities.",
    "stats.routeEmpty": "No route yet",
    "stats.routeInputLabel": "Add city",
    "stats.routePlaceholder": "Type a city, e.g. Hangzhou",
    "stats.routeAdd": "Add",
    "stats.routeReset": "Reset route",
    "stats.routeAddShort": "Please enter at least 2 characters.",
    "stats.routeAddNotFound": "City not found. Try a more complete name.",
    "stats.routeAddDuplicate": "This point is already in the route.",
    "stats.routeAddFailed": "Unable to add this city now. Check network and retry.",
    "stats.routeClearConfirm": "Reset the route to default \"Lianyungang -> Shanghai\"?",
    "stats.footprintEmpty": "No footprint points yet.",
    "stats.routeCount": "{count} stops",
    "stats.bar.dev": "Build",
